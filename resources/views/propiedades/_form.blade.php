<div class="form-group card-body">
    <div class="row mt-4">
        <div class="col-md-6 text-left">
            <label for="" class="">Nombre de la Propiedad</label>
            <p class=" text-blue">Dale un nombre a tu propiedad que haga distinguirla de las demas</p>
    ...
    <input type="submit" value="{{ $btnText}}" class="btn btn-primary mr-5">
    </div>
</div>
