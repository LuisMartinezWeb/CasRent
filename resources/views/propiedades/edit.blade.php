...
<div class="card text-center">
    ...
    <div class="card-body">
        <div class="container">
            ...
            <p>Edite los datos que usted requiera para su propiedad</p>
            <form method="POST"  action="{{ route('propiedades.update',$propiedad->id) }}" files="true" enctype="multipart/form-data">
                @csrf @method('PUT')
